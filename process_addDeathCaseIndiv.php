...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($geoID !== false) {
        ...
        if ($result === true) {
            echo '<script>alert("Report Death Case Successfully"); window.location.href = "./dashboard.php?active-tab=1";</script>';
        } else {
            echo '<script>alert("The pet has been deceased."); window.location.href = "./dashboard.php?active-tab=1";</script>';
        }
    }
}
?>

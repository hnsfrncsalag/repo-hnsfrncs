...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["accept"]) || isset($_POST["reject"])) {
        ...
        if ($result === true) {
            ...
            $notificationResult = $notification->addRegNotif($brgyID, $MAOID, $residentID, $notifType, $notifDate, $notifMessage);
                        ...
                        <div class="container mt-4">
                            ...
                            <ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    $newResidentsQuery = "SELECT * FROM resident WHERE (name LIKE ? OR email LIKE ?) AND brgyID = ? AND userStatus = 0 ORDER BY created_at DESC";

                                    // Prepare and execute the SQL query
                                    $stmt_new = mysqli_prepare($conn, $newResidentsQuery);
                                    $search_term = "%$search_new%"; // Adding wildcards for LIKE search
                                    mysqli_stmt_bind_param($stmt_new, "ssi", $search_term, $search_term, $brgyID); // Assuming $residentID is available
                                            ...
                                            <div class="card-body">
                                                <form method="POST" action="dashboard1.php?active-tab=1">
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" id="newSearch" name="newSearch" placeholder="Search by Name or Email" value="<?php echo $search_new; ?>">
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            <form method="post" action="./dashboard1.php?active-tab=1">
                                                                                ...
                                                                                <input type="hidden" name="residentID" value="<?php echo $residentID; ?>">
                                                                                <input type="hidden" name="notifType" id="notifType" value="9">
                                                                                ...
                                                                                <button type="submit" name="accept" class="btn btn-success my-1" onclick="document.getElementById('notifMessage').value='Your account has been accepted.'">Accept</button>
                                                                                <button type="submit" name="reject" class="btn btn-danger my-1" onclick="document.getElementById('notifMessage').value='Your account has been rejected.'">Reject</button>
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                            <?php }
                                    ...
                                    // Construct the SQL query to filter data based on the search terms
                                    // Modify this query according to your database structure and requirements
                                    $validResidentsQuery = "SELECT * FROM resident WHERE (name LIKE ? OR email LIKE ?) AND brgyID = ? AND userStatus = 1";

                                    // Prepare and execute the SQL query
                                    $stmt_valid = mysqli_prepare($conn, $validResidentsQuery);
                                    $search_term_valid = "%$search_valid%"; // Adding wildcards for LIKE search
                                    mysqli_stmt_bind_param($stmt_valid, "ssi", $search_term_valid, $search_term_valid, $brgyID); // Assuming $residentID is available
                                        ...
                                        <div class="table">
                                            <div class="card-body">
                                                <form method="POST" action="dashboard1.php?active-tab=2">
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" id="validSearch" name="validSearch" placeholder="Search by Name or Email" value="<?php echo $search_valid; ?>">
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            <form method="post" action="addPetByBao.php">
                                                                                ...
                                                                                <input type="hidden" name="ResidentName" value="<?php echo $row['name']; ?>">
                                    ...
                                    // Construct the SQL query to filter data based on the search terms
                                    // Modify this query according to your database structure and requirements
                                    $rejectedResidentsQuery = "SELECT * FROM resident WHERE (name LIKE ? OR email LIKE ?) AND brgyID = ? AND userStatus = 2";
                                    ...
                                    mysqli_stmt_bind_param($stmt_rejected, "ssi", $search_term_rejected, $search_term_rejected, $brgyID); // Assuming $brgyID is available
                                        ...
                                        <div class="table">
                                            <div class="card-body">
                                                <form method="POST" action="dashboard1.php?active-tab=3">
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" id="rejSearch" name="rejSearch" placeholder="Search by Name or Email" value="<?php echo htmlspecialchars($search_rejected); ?>">

                ...
                <main class="row overflow-auto">
                    <div class="col-md-10 p-1 mt-2 my-auto mx-auto">
                        ...
                        <div class="col-md-auto">
                            <a href="./dashboard.php?active-tab=1" class="btn btn-primary rounded-circle p-2">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="pdescription" id="pdescription" rows="3" style="font-style: italic;" placeholder="Deskripsyon sang imo sapat. Example: Maniwang, Putot, Malaba, etc."></textarea>
                        </div>
...
<script>
   function toggleCurrentVac() {
    var statusVacCheckbox = document.getElementById("statusVac");
    var currentVacInput = document.getElementById("currentVac");

    if (statusVacCheckbox.checked) {
        currentVacInput.disabled = false;
    } else {
        currentVacInput.disabled = true;
    }
}
...
<?php
                                ...
                                $sql = "SELECT notifMessage, notifDate, notifType FROM notification WHERE notifType IN (9, 10, 11, 12, 13) AND residentID = ? ORDER BY notifDate DESC";
                                                        ...
                                                        <?php foreach ($allNotifs as $notif) { ?>
                                                                <tr>
                                                                    ...
                                                                    switch ($notif['notifType']) {
                                                                        case 1:
                                                                            $redirectUrl = 'dashboard.php?active-tab=1&page_add=1#addPets';
                                                                            break;
                                                                        case 2:
                                                                            $redirectUrl = 'dashboard.php?active-tab=2&page_bite=1#bitePets';
                                                                            break;
                                                                        // case 3:
                                                                        //     $redirectUrl = 'dashboard.php?active-tab=3&page_death=1#deathPets';
                                                                        //     break;
                                                                        case 3:
                                                                            $redirectUrl = 'dashboard.php?active-tab=4&page_sus=1#suspectedPets';
                                                                            break;
                                                                        default:

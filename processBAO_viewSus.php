    ...
    if (isset($_GET["caseID"])) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // $markerCode .= "marker$geoID.bindPopup('Name: $pname<br>Barangay: $barangay <br><form method=\"POST\" action=\"process_updateSusLocation.php\"><input type=\"hidden\" name=\"caseID\" value=\"$caseID\"><button type=\"submit\" name=\"geoID\" value=\"$geoID\" class=\"btn btn-primary\">Update Location</button></form>').openPopup();\n";
            }
            // echo $markerCode;
        }
    } else {
                    ...
                    <div class="col-md-10 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-2 p-3">
                            <div class="col-md-auto">
                                <a href="./pin_location.php?barangay_suspected=<?php echo $brgyID ?>" class="btn btn-lg align-item-start">
                                    <i class="bi bi-arrow-left"></i>
                                </a>
                            </div>

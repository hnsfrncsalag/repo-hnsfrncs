            ...
            <div class="row overflow-auto">
                        ...
                        <ul class="nav nav-underline flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto justify-content-center align-items-center align-items-sm-start" id="menu">
                            ...
                            <li class="nav-item">
                                <form method="post" action="./pin_location.php?active-tab=1" style="display: inline;">
                                    ...
                                    <input type="hidden" name="residentID" value="<?php echo $residentID; ?>">
                                    <input type="hidden" name="name" value="<?php echo $name; ?>">
                                    <button type="submit" class="nav-link text-dark active">
                ...
                <div class="col d-flex flex-column h-sm-200">
                    ...
                    <button value="Back" class="btn btn-primary">Back</button> -->
                                ...
                                <h1>View Pinned Location </h1>
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="resident-tab" data-toggle="tab" href="#resident" role="tab" aria-controls="resident" aria-selected="true">Resident</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <!-- resident Tab -->
                                    <div class="tab-pane fade show active" id="resident" role="tabpanel" aria-labelledby="resident-tab">
                                        <form action="" method="GET" id="residentForm">
                                            <div class="table">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <!-- <label for="barangaySelectresident">Select Barangay:</label> -->
                                                        <select class="form-control" id="barangaySelectresident" name="barangay_resident" onchange="submitForm('residentForm')">
                                        ...
                                        <!-- Display resident data here -->
                                        <div>
                                            <?php
                                            if (isset($_GET['barangay_resident'])) {
                                                $selected_barangay = $_GET['barangay_resident'];
                                                ...
                                                // Query to fetch resident data for the selected barangay
                                                $sql = "SELECT * FROM resident as r JOIN barangay as b ON b.brgyID = r.brgyID WHERE userStatus = 1 AND r.brgyID = ? ORDER BY name DESC";
                                                        ...
                                                        <table id="registered" class="table text-center table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($rows as $row) {
                                                                    ...
                                                                    echo "<td>";
                                                                    echo "<form method='post' action='processBAO_residentView.php'>";
                                                                    echo "<input type='hidden' name='brgyID' value='" . $selected_barangay . "'>";
                                                                    echo "<input type='hidden' name='userID' value='" . $row['residentID'] . "'>";
                                                                    echo "<button type='submit' name='accept' class='btn btn-success'>View Location</button>";
                                                                    echo "</form>";
                                                                    echo "</td>";
                                                                    echo "</tr>";
                                                                }
                                            ...
                                            <?php
                                                    ...
                                                    echo "<p>No resident found in selected barangay</p>";
                                                }
                                            ...
                                            ORDER BY c.date DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        // echo "<td>" . htmlspecialchars($row["bpartBitten"]) . "</td>";
                                ...
                                <div class="tab-pane fade" id="death" role="tabpanel" aria-labelledby="death-tab">
                                    ...
                                    <div>
                                        ...
                                        //                     echo '<td>' . $row['barangay'] . '</td>';
                                        //                     echo '<td>' . ($row['confirmedRabies'] == 0 ? 'Natural Cause' : 'Rabies') . '</td>';
                                        //                     echo '<td>
                                        //     <form method="post" action="processBAO_viewDeath.php">
                                        //     <input type="hidden" name="caseID" value="' . $row['caseID'] . '">
                                        //     <input type="hidden" name="brgyID" value="' . $selected_barangay . '">
                                        //     <button type="submit" name="accept" class="btn btn-success">View Location</button>
                                        // </form>
                                    ...
                                    <div class="tab-pane fade" id="suspected" role="tabpanel" aria-labelledby="suspected-tab">
                                        ...
                                        <form method="post" action="processBAO_viewSus.php">
                                            ...
                                            <button type="submit" name="accept" class="btn btn-success">View Location</button>
                                                    ...
                                                    //             <a class="page-link" href="tabular.php?barangay_suspected=' . $selected_barangay . '&page=' . $b . '">' . $b . '</a>
                                                    //         </li>';
                                                    // }
                                                    // echo '</ul></div>';
                                                } else {

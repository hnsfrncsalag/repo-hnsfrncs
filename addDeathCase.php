                ...
                <main class="row overflow-auto">
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-4">
                            <div class="">
                                <a href="./BAOpetdashboard.php?active-tab=3" class="btn btn-lg align-item-start">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="submit" value="Report Case" class="btn btn-primary mb-2" btn-lg onclick="getLocation()">
                            </form>

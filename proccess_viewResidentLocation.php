    ...
    if (isset($_GET["userID"])) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $markerCode .= "marker$geoID.bindPopup('Name: $name<br>Barangay: $barangay <br><form method=\"POST\" action=\"process_updateResidentLocation.php\"><input type=\"hidden\" name=\"page_valid\" value=\"$page_valid\"><button type=\"submit\" name=\"geoID\" value=\"$geoID\" class=\"btn btn-primary\">Update Location</button></form>').openPopup();\n";
            }
                    ...
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-2 p-3">
                            ...
                            <div class="col-md-auto">
                                <a href="./dashboard1.php?active-tab=2&page_valid=<?php echo ($page_valid); ?>" class="btn btn-lg align-item-start">
                                    <i class="bi bi-arrow-left"></i>
                                </a>
                            </div>
                            <div>
                                <h1 class="mt-3 mb-4">Resident Location:</h1>
                                <div id="map"></div>

...
<body>
    <div class="container-fluid overflow-hidden">
        <div class="row vh-100 overflow-auto">
            <div class="col-12 col-sm-3 shadow-sm bg-white col-xl-2 px-sm-2 px-1 d-flex sticky-top">
                    ...
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-2 p-3">
                            <div class="col-md-auto">
                                <a href="./dashboardDeathCases.php?active-tab=2&page_valid=<?php echo ($page_valid); ?>" class="btn btn-lg align-item-start">
                                    <i class="bi bi-arrow-left"></i>
                                </a>
                            </div>

                            <h1 class=" mt-3 mb-4">Death Location:</h1>
                            <div id="map"></div>

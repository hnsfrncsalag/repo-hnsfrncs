...
<body>
    <div class="container-fluid overflow-hidden">
        <div class="row vh-100 overflow-auto"> <!-- Adjusted to vh-100 -->
            ...
            <div class="col d-flex flex-column h-100"> <!-- Adjusted to h-100 -->
                <main class="row overflow-auto">
                    <div class="col-md-8 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-2 p-3">
                            ...
                            <!-- Hidden form -->
                            <form method="POST" action="process_confirmDeath.php" id="newLocForm">
                            ...
                            <div class="mb-3"></div>
                            <!-- <form method="POST" action="dashboardDeathCases.php?active-tab=1" id="newLocForm">

                ...
                <main class="row overflow-auto">
                    <div class="col-md-10 p-1 mt-2 my-auto mx-auto">
                        ...
                        <div class="col-md-auto">
                            <a href="./BAOpetdashboard.php?active-tab=1" class="btn btn-primary rounded-circle p-2">
                                <i class="bi bi-arrow-left"></i>
                            </a>
                        </div>
                                    <h1>Pet Registration Form</h1>
                                <form id="addPetForm" action="process_addPetBAO.php" onsubmit="return confirmAdd();" method="POST">
                                    <div class="row">
                                    <div class="mb-3">

                ...
                <main class="row overflow-auto">
                    <div class="col-md-10 p-1 mt-2 my-auto mx-auto">
                        <div class="container mt-4">
                            <div class="">
                                <a href="./BAOpetdashboard.php?active-tab=2" class="btn btn-lg align-item-start">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <select class="form-control" name="bpartsBitten[]" id="bpartBitten' + victimCounter + '" required>
                                                                    ...
                                                                    <option value="4" style="font-style: italic;">Lower Extremities Area/ Hita kag Tiil nga parte sang lawas</option>
                                                                        ...
                                                                        <button type="button" class="btn btn-success" onclick="addVictimField()"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                                                <path fill="#fafafa" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" />
                                                                            </svg></button>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <input type="hidden" name="notifType" id="notifType" value="6">
                                                                            <input type="hidden" name="notifDate" id="notifDate" value="<?php echo date('Y-m-d'); ?>">
                                                                            <input type="hidden" name="notifMessage" id="notifMessage" value="An Bite case has been recorded.">
                                ...
                                <script>
                                    ...
                                    function addVictimField() {
                                        ...
                                        newField.innerHTML =
                                            ...
                                            '</div>' +
                                            '<button type="button"class="btn btn-danger ms-1" onclick="removeVictimFields(\'' + victimId + '\')"><svg xmlns="http://www.w3.org/2000/svg" height="14" width="12.25" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg></button>' + // Remove button
                                            '</div>';
                        ...
                        <div class="tab-pane fade" id="Unknown">
                            <div class="mb-3">
                                ...
                                <form method="POST" action="process_Unknown.php" id="addUnknown">
                                    ...
                                    <button type="button" class="btn btn-success mb-1" onclick="addUnknown()"><svg xmlns="http://www.w3.org/2000/svg" height="14" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                            <path fill="#fafafa" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" />
                                        </svg></button>
                                    ...
                                    <input type="submit" class="btn btn-danger mt-2 mb-2" value="Report Case" onclick="getLocationAndSubmit()" form="addUnknown">
                                </form>
                    ...
                    <script>
                        ...
                        function addUnknown() {
                            ...
                            newField.innerHTML =
                                ...
                                '<textarea type="text" class="form-control" name="descriptions[]" id="description' + victimCounter + '" required style="font-style: italic;" placeholder="Deskripsiyon sang natabo kag sang sapat"></textarea>' +
                                '</div>' +
                                '<button type="button" class="btn btn-success" onclick="addUnknown(\'' + victimId + '\')"><svg xmlns="http://www.w3.org/2000/svg" height="14" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg></button>' +
                                '<button type="button" class="btn btn-danger m-1" onclick="removeUnknown(\'' + victimId + '\')"><svg xmlns="http://www.w3.org/2000/svg" height="14" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg></button>' + // Remove button
                                '</div>';
